...
void test_swizzle_examples(int ps) {
    ...
    test_swizzle<Swizzle<2, 1, 3>, Layout<Shape<_4, _64>, Stride<_64, _1>>>("Sw213_L4x64_R", ps);
    ...
    // test_swizzle<Swizzle<2, 4, 2>, Layout<Shape<_4, _64>, Stride<_64, _1>>>("Sw242_L4x64_R", ps);
